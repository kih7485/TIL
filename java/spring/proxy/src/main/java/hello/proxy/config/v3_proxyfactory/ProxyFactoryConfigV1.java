...
public class ProxyFactoryConfigV1 {
    ...
    public OrderControllerV1 orderControllerV1(LogTrace logTrace){
        ...
        log.info("proxyFactory : {}, target : {}", proxy.getClass(), orderController.getClass());
        return proxy;
    }

    @Bean
    public OrderServiceV1 orderServiceV1(LogTrace logTrace){
        OrderServiceV1 orderService = new OrderServiceV1ImplV1(orderRepositoryV1(logTrace));
        ProxyFactory factory = new ProxyFactory(orderService);
        factory.addAdvisor(getAdvisor(logTrace));
        OrderServiceV1 proxy  = (OrderServiceV1) factory.getProxy();
        log.info("proxyFactory : {}, target : {}", proxy.getClass(), orderService.getClass());
        return proxy;
    }
