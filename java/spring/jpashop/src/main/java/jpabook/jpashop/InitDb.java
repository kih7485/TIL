...
public class InitDb {
    ...
    static class InitService{
        ...
        public void dbInit1(){
            Member member = createMember("userA", "진주", "1", "111111");
            em.persist(member);

            Book book1 =  createBook("S BOOK A", 20000, 200);
            em.persist(book1);

            Book book2 = createBook("S BOOK B", 20000, 200);
            em.persist(book2);
        ...
        public void dbInit2(){
            ...
            Book book1 = createBook("BOOK A", 20000, 200);
            em.persist(book1);

            Book book2 = createBook("BOOK A", 40000, 400);
            em.persist(book2);
