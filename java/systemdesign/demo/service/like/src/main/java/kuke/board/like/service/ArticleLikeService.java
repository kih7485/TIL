...
public class ArticleLikeService {
    ...
    public void likePessimisticLock1(Long articleId, Long userId){
        ...
        //최초 요청시에 update 되는 레코드가 없으므로 1로 초기화한다.
        //트래픽이 몰릴때는 유실될 수 있으므로, 게시글 생성 시점 미리 0으 초기화 해둘 수도 있다.
        if(result == 0){
        ...
        outboxEventPublisher.publish(
                ...
                ArticleLikedEventPayload.builder()
                        ...
                        .articleLikedCount(count(articleLike.getArticleLikeId()))
                        .build(),
    ...
    public void likePessimisticLock2(Long articleId, Long userId){
        ...
        ArticleLikeCount articleLikeCount = articleLikeCountRepository
                .findLockedByArticleId(articleId).orElseGet(() -> ArticleLikeCount.init(articleId, 0L));
