...
public class LikeApiTest {
    ...
    void likeAndUnlikeTest(){
        ...
        ArticleLikeResponse articleLike1 = read(articleId, 1L);
        ArticleLikeResponse articleLike2 = read(articleId, 2L);
        ArticleLikeResponse articleLike3 = read(articleId, 3L);

        System.out.println("articleLike1 = " + articleLike1);
        System.out.println("articleLike2 = " + articleLike2);
        System.out.println("articleLike3 = " + articleLike3);
